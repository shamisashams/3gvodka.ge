...
class ProductHelper
{
     ...
     * @return array
     */
    public static function getRoutes($baseRouteName = 'admin', $baseModuleName = 'product')
    {
     ...
     * @return array
     */
    public static function getLang($baseLangName = 'admin', $baseModuleName = 'product')
    {
        ...
        $langData = [
            ...
            'brand' => __($baseFullLangName . 'brand'),
            'manufacturer' => __($baseFullLangName . 'manufacturer'),
            'country' => __($baseFullLangName . 'country'),
