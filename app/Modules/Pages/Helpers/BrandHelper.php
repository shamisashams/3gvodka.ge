...
class BrandHelper
{
     ...
     * @return array
     */
    public static function getRoutes($baseRouteName = 'admin', $baseModuleName = 'brand')
    {
     ...
     * @return array
     */
    public static function getLang($baseLangName = 'admin', $baseModuleName = 'brand')
    {
        ...
        $langData = [
            ...
            'main_image' => __($baseFullLangName . 'main_image'),
            'banner_image' => __($baseFullLangName . 'banner_image'),
            'icon_image' => __($baseFullLangName . 'icon_image'),
