...
<!--                                    </div>-->
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">{{ lang.main_image }}</label>
                                        <div class="col-md-6">
                                            <input style="display: block !important;" id="main"
                                                   type="file"
                                                   v-on:change="handleFileUpload('main')"/>
                                        </div>

                                        <div v-if="form.images && form.images.main">
                                            <div class="col-md-offset-2 col-md-4 padding-t">
                                                <img :src="form.images.main.item.full_src" style="width: 100%;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">{{ lang.banner_image }}</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">{{ lang.icon_image }}</label>
                                        <div class="col-md-6">
                                            <input style="display: block !important;" id="icon"
                                                   type="file"
                                                   v-on:change="handleFileUpload('icon')"/>
                                        </div>

                                        <div v-if="form.images && form.images.icon">
                                            <div class="col-md-offset-2 col-md-4 padding-t">
                                                <img :src="form.images.icon.item.full_src" style="width: 100%;">
                                            </div>
                                        </div>
