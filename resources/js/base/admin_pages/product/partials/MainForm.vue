                    ...
                    <template v-for="locale in locales">
                        <el-tab-pane class="" :label="locale" :name="locale">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group editor-large">
                                    ...
                                    <div class="col-md-10">
                                        <ckeditor :editor="editor"
                                                  v-model="form[locale].short_description"></ckeditor>
                                    </div>
                                </div>
                                ...
                                <div class="form-group dashed">
                                    <label class="col-md-1 control-label"><span
                                        class="text-danger">*</span>{{ lang.manufacturer }} <span class="grey">{{
                                            locale
                                        }}</span>:</label>
                                    <div class="col-md-10 uppercase-medium">
                                        <input class="form-control" maxlength="150"
                                               :disabled="loading"
                                               :config="editorConfigData"
                                               v-model="form[locale].manufacturer">
                                    </div>
                                </div>

                                <div class="form-group dashed">
                                    <label class="col-md-1 control-label"><span
                                        class="text-danger">*</span>{{ lang.country }} <span class="grey">{{
                                            locale
                                        }}</span>:</label>
                                    <div class="col-md-10 uppercase-medium">
                                        <input class="form-control" maxlength="150"
...
export default {
    ...
    computed: {
        brandsJson: function (){
            return this.brands ? JSON.parse(this.brands) : {};
        }
    },
